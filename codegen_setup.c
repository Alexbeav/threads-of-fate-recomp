...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Threads of Fate",
    .project_root_env = "THREADS_OF_FATE_PROJECT_ROOT",
    .build_dir_env = "THREADS_OF_FATE_BUILD_DIR",
    .force_setup_env = "THREADS_OF_FATE_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_010.19_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Threads_of_Fate_Recompiled",
    .prepare_note =
