# Threads of Fate Recompiled

This release candidate uses PSXRecomp and the shared recomp-ui launcher.
You must supply your own SLUS-01019 game disc and SCPH-5502/5552 Europe BIOS.
...
2. Start `Threads_of_Fate_Recompiled` (`.exe` on Windows).
