...
#
# Writes: dist/threads-of-fate-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix threads-of-fate \
  --exe-name Threads_of_Fate_Recompiled \
  --display-name "Threads of Fate Recompiled" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --runtime-dir mods \
  --disc-hint "Threads of Fate (USA, Canada).cue" \
